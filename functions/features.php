...
/**
 * Theme environment (live/staging) lookup, used to gate programmatic ad networks
 * (see header.php) so they don't fire while testing on staging.
 *
 * @return string 'live' or 'staging' (defaults to 'staging').
 */
...
/**
 * Theme Environment settings page: toggles bd_get_theme_environment() between
 * live and staging so ad networks can be disabled while testing.
 */
function bd_theme_environment_setup_main_page(): void
{
    ...
    <div class="wrap">
        ...
        <p>Choose whether the theme should treat this site as Live (production) or Staging (test). Programmatic ad networks are disabled while set to Staging.</p>
        <form action="options.php" method="post">
            <?php
