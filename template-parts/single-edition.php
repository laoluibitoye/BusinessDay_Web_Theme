                    ...
                    <article>
                        ...
                        <?php
                            ...
                            if ( is_user_logged_in() ) {
                                ...
                                // Fallback: bd_user_has_active_subscription() can miss genuine subscribers
                                // whose local metadata was never synced (see functions/magnaquest-api.php
                                // for why). This independent, email-based check only ADDS access, never revokes it.
                                if ( ! $has_sub ) {
