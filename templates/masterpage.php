                                            ...
                                            <div class="post-info">
                                                ...
                                                <div class="post-meta">
                                                    <span class="post-author">
                                                        <a
                                                            href="<?= get_author_posts_url(get_the_author_meta('ID', get_post_field('post_author', $post->ID))) ?>">
                                                ...
                                                <p
                                                    style="font-size: 16px; line-height: 1.5; height: 6em; overflow: hidden; margin-top: 10px;">
                                                    <?= $forced_excerpt; ?>
                                                </p>
                                            </div>
                                        </article>
                        ...
                        <div class="col-lg-3 recent mt-2">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="top-stories-new owl-carouselx">
                                        <article>
                                            ...
                                            <div class="post-info">
                                                <h2
                                                    style="font-size: 1.5em; font-weight: 700; margin-top: 0.2em; line-height: 1em;">
                            ...
                            <div class="ad-container mobile-only d-sm-block d-md-none">
                                ...
                                <div class="ad-container" style="text-align: center; line-height: 0; width: 100%;">
                                    <p
                                        style="font-size: 10px; color: #999; letter-spacing: 2px; text-transform: uppercase; margin: 0 0 5px 0; line-height: 1.2;">
                                    ...
                                    <iframe
                                        ...
                                        width="970" height="250" frameborder="0" scrolling="no"
                            ...
                            <a class="btn btn-sm btn-danger" href="https://businessday.ng/tag/bdrecent/">Read more
                                >></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="col-lg-12">
                    <div class="col-lg-12 pro-section" style="background-color: #E7E7E7 !important; color: black">
                        <section class="news-block-2">
                            <div class="container">
                                <div class="section-heading">
                                    <a href="https://businessday.ng/category/pro/" target="_blank">
                                                ...
                                                <div class="col-lg-3 mb-3">
                                                    <article>
                                                        ...
                                                        <div class="post-info">
                                                            ...
                                                            <div class="post-meta">
                                                                <span
                                                                    class="post-date"><?= custom_time_format($post->post_date, 'full') ?></span>
                                                            </div>
                                                        </div>
                                                    </article>
                                                </div>
                ...
                <div class="col-lg-9">
                    ...
                    <div class="ad-container desktop-only d-none d-md-block">
                        <div id='div-gpt-ad-1731238848673-0' class="d-flex justify-content-around"
                                ...
                                if (!empty($news1)):
                                    foreach ($news1 as $post):
                                        ...
                                        <div class="col-lg-4 col-md-6 mb-4">
                                            <!-- Added col-md-6 and margin-bottom for better spacing -->
                                            <article>
                                                <span class="category">
                                                ...
                                                <div class="post-info">
                                                    ...
                                                    <div class="post-meta">
                                                        <span class="post-author">
                                                            <a
                                                                href="<?= get_author_posts_url(get_post_field('post_author', $post->ID)) ?>">
                                                                <?= get_the_author_meta('display_name', get_post_field('post_author', $post->ID)) ?>
                                                            </a>
                                                        </span>
                                                        <span class="post-time"><?= timeAgo($post->post_date) ?></span>
                                                    ...
                                                    <article>
                                                        ...
                                                        <div class="post-info">
                                                            ...
                                                            <div class="post-meta">
                                                                ...
                                                                <span
                                                                    class="post-time"><?= custom_time_format($post->post_date, 'full') ?></span>
                                                            </div>
                                                        </div>
                                                    </article>
                                                </div>
...
<div class="ad-container desktop-only d-none d-md-block">
    ...
    <div id='div-gpt-ad-1731239152173-0' class="d-flex justify-content-around"
